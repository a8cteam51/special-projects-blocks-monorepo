			...
			<InspectorControls>
				<PanelBody title={__('Marquee Settings', 'marquee')}>
					<div style={{ marginBottom: '16px' }}>
						<Button
							variant={isPreviewingAnimation ? 'primary' : 'secondary'}
							onClick={() => setIsPreviewingAnimation(!isPreviewingAnimation)}
							style={{ width: '100%' }}
						>
							{isPreviewingAnimation ? __('Stop Preview', 'marquee') : __('Preview Animation', 'marquee')}
						</Button>
					</div>
					<SelectControl
					...
					<ToggleControl
						...
						help={__('Add fade effect to left and right edges', 'marquee')}
						checked={fadeEdges}
